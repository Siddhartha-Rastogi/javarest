...
public class DocuSignUtils {
	...
	public static String getBaseUrl(String authenticationHeader, String url)
		...
		String baseURL;		//String accountId;
		String body;
		String response;
		int status;
	...
	///////////////////////////////////////////////////////////////////////////////////////////////
	public static String errorParse(HttpURLConnection conn, int status) { 
		BufferedReader br;
		String line;
	...
	/**
	 * This will generate payload to be sent as String
	 * @param docuSignDoc
	 * @return body as String which is payload in format of String
	 */
	public static String getBodyAsString(DocuSignDocument docuSignDoc){
		
		//		Extracting values from request Body of POST request
		String userName 					= docuSignDoc.getUserEmail();
		String documentGUID 				= docuSignDoc.getDocumentGUID();
		String userEmail 					= docuSignDoc.getUserEmail();
		...
		writer.println("Content-Disposition: file; filename=\""
				...
				+ "\"; documentid=\"1\"");
		writer.println("");
		String strBody = stringWriter.toString();
		return strBody;
	}
